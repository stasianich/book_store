...
class Version20200720134132 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO "book"(id, title, photo, price, description, created_time, updated_time, is_ordered)
                           VALUES(:id, :title, :photo, :price, :description, :created_time, :updated_time, :is_ordered)',
                           [
                               ':id' => '10bc05ea-a876-400e-81bc-ffdc4c74dbaf',
                               ':title' => 'test_title01',
                               ':photo' => 'assets/main/images/cake.png',
                               ':price' => 30000,
